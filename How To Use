...
Table 2: a table that contains all data of our customers including those that do not have pos terminal assigned to them. Columns include(customer_id which is my only unique identifier, terminal_id, subsector_name, segment, division, location).
